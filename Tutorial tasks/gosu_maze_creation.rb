...
while (row_index < y_cell_count)
  ...
  @columns [column_index][row_index] = cell
  if (column_index != 0 )
    cell.north = [row_index][column_index -1 ]
  else 
    cell.north = nil
  end 
  if (column_index != y_cell_count)
    cell.south = [row_index][column_index + 1]
  else 
    cell.south = nil
  end 
  if (row_index != 0 )
    cell.east = [row_index -1][column_index]
  else 
    cell.east = nil
  end 
  if (row_index != x_cell_count)
    cell.west = [row_index + 1][column_index]
    else
      cell.west = nil
    end 
    row_index += 1 
...
puts "Cell x: #{column_index}, y: #{row_index} north: #{[row_index][column_index -1 ].north} south: #{} east: #{} west: #{}" 
 puts "Cell x: #{column_index}, y: #{row_index} north: #{} south: #{} east: #{} west: #{}"
  end
